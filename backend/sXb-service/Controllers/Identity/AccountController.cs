...
using sXb_service.Models.Identity.AccountViewModels;
using sXb_service.Models.ViewModels;
using sXb_service.Services;
using RegisterViewModel = sXb_service.Models.Identity.AccountViewModels.RegisterViewModel;
using sXb_service.Controllers.Identity;

namespace sXb_service.Controllers.Identity
{
    [Authorize]
